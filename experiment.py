...
def getResultsForElection(votes: [int], weights: [Number], seat_assign: [int]) \
    ...
    """
    results_list = [providesWLQ(votes, weights, seat_assign), providesWLQ_X(votes, weights, seat_assign),
                    providesWLQ_1(votes, weights, seat_assign), providesWUQ(votes, weights, seat_assign),
...
def providesWLQ(votes: [int], weights: [Number], seat_assign: [int]) -> bool:
    """
    Returns whether a seat assignment provides WLQ for the election instance.
...
def providesWUQ(votes: [int], weights: [Number], seat_assign: [int]) -> bool:
    """
    Returns whether a seat assignment provides WUQ for the election instance.
